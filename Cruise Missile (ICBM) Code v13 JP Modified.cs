...
string TimerblockName = missileGroupName + " Trigger Timer Block";
...
IMyTimerBlock TimerTrigger = null;
...
bool GetBlocks()
{
    ...
    TimerTrigger = GridTerminalSystem.GetBlockWithName(TimerblockName) as IMyTimerBlock;
